...
var app1 = new Vue({
    el: '#app',
    components: {
        'bom-component': httpVueLoader('bom-component.vue'),
        'kit-component': httpVueLoader('kit-component.vue'),
        'download-component': httpVueLoader('download-component.vue'),
    }, // --- End of components --- //
    data: {
        fileCount: 0,
        uploadFile: null,
    ...
    mounted: function(){
        ...
        uibuilder.onChange('msg', function(newVal){
            ...
            if (msg.hasOwnProperty('download_enabled')) vueApp.download_enabled = msg.download_enabled
        ...
        uibuilder.onChange('ioConnected', function(newVal){
            ...
            if (vueApp.msgRecvd === '[Nothing]') vueApp.msgRecvd = uibuilder.msg
        })
